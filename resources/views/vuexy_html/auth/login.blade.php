...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin-layout/app-assets/css/pages/authentication.css')}}">
    <!-- END: Page CSS-->
                                                ...
                                                <div class="card-body pt-1">
                                                    <form >
                                                        <fieldset class="form-label-group form-group position-relative has-icon-left">
                                                            <input type="text" class="form-control" id="user-name" placeholder="Email" v-model="email">
                                                            <span style="color:red;" v-if="form.error && form.validations.email">
                                                        ...
                                                        <fieldset class="form-label-group position-relative has-icon-left">
                                                            <input type="password" class="form-control" id="user-password" placeholder="Password" v-model="password" >
                                                            <span  style="color:red;" v-if="form.error && form.validations.password">
                                                        ...
                                                        {{--</div>--}}
                                                        <button @click="login" type="submit"  class="btn btn-primary float-right btn-inline" :disabled="form.disabled">
...
<script src="{{ url('js/auth.js?aaa=nn') }}"></script>
</body>
<!-- END: Body-->
