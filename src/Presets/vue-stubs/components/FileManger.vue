...
">
                        ...
                        <div class="col-4" >
                            <div class="vx-row">
                                <div class="vx-col w-full">
                                    <vs-input  label="ابحث " @keyup.enter="getAllData"  v-model="search_word" class="mt-1 mb-1 w-full" name="search_word"   />
                                </div>
                            </div>
                            ...
                            <div class="vx-row">
                                <div class="vx-col w-full">
                                    <vs-input v-if="choicesImageSelected" label="وصف الصورة "  v-model="photo_caption" class="mt-1 mb-1 w-full" name="photo_caption"  />
                                </div>
                            </div>
                            <div class="vx-row">
                                <div class="vx-col ">
                                    <vs-button v-if="choicesImageSelected" @click="destory" color="danger" type="filled">حذف</vs-button>
                                    <vs-button v-if="choicesImageSelected" @click="save" color="success"  type="filled">حفظ</vs-button>
                                </div>
                            </div>
        ...
        <div class="row mx-0 mr-3 my-2" style="float: right;" slot="footer">
            <vs-button class="mr-1" @click="saveData" >{{test.save}}</vs-button>
            <vs-button type="border" color="danger" @click="isSidebarActiveLocal = false">{{test.cancel}}</vs-button>
        </div>
    </vs-sidebar>
</template>
